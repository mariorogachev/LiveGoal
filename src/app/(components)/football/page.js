  ...
  return (
    <>
      <div className="flex flex-wrap items-stretch dark:text-white max-h-max mt-36 justify-center">
        ...
        <div className="dark:bg-gray-700 bg-trapnsparent h-32 sm:h-80 w-full sm:w-1/3 md:w-1/4 lg:w-1/6  mx-3 relative">
          <DateSelector onDateChange={handleDateChange} />
          <div className="dark:bg-gray-700 absolute top-full bg-white rounded-2xl max-h-max sm:h-full w-full sm:w-80 shadow-2xl">
