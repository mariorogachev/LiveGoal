...
export default function Header(){
  ...
  const handleThemeSwitch = () => {
    ...
    return(
        ...
        <nav className={`navbar ${scrolling ? 'bg-gray-200' : ''} transparent  fixed w-full z-20 top-0 start-0`}>
  <div className=" max-w-screen-xl  flex flex-wrap items-center justify-between mx-auto p-3 ">
    ...
    id="logo-image"
      ...
      height={100}
    />
      <h1 className="ml-3 self-center text-7xl text-gray-900 md:text-7xl lg:text-7xl dark:text-gray-200">LiveGoal</h1>
      </div>
